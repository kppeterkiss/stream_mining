...
public class KMeansData {
	...
	public static DataSet<Centroid_> getDefaultCentroidDataSet(ExecutionEnvironment env) {
		List<Centroid_> centroidList = new LinkedList<Centroid_>();
		for (Object[] centroid : CENTROIDS) {
			centroidList.add(
					new Centroid_((Integer) centroid[0], (Double) centroid[1], (Double) centroid[2]));
		}
